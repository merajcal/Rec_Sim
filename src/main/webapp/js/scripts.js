...
aprsApp.controller('ModalDemoCtrl', function ($scope, $modal, $log, $http) {

	  $scope.items = ['item1', 'item2', 'item'];
...
aprsApp.controller('ModalInstanceCtrl', function ($scope, $modalInstance, items) {
